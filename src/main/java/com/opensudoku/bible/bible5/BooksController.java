...
import com.opensudoku.bible.bible5.util.JsfUtil;
import com.opensudoku.bible.bible5.util.PaginationHelper;
...
public class BooksController implements Serializable {
    ...
    @EJB
    private com.opensudoku.bible.bible5.BooksFacade ejbFacade;
