 ...
 * @author mark
 */
public class BibleContent_hb5 {

    String BIBLE_BASE = "/home/mark/bible/";

    public static void main(String[] args) throws IOException, ParseException {
//        new BibleContent().getContent();
//        new BibleContent().getContent("tw",1,1);
//        new BibleContent().getContent("tw",40,6);
        BibleContent_hb5 bc = new BibleContent_hb5();
        bc.createBookSql_hb5("tw");
//        bc.createBookSql("kjv");
     ...
     * @param book 1 to 66
     */
    public void createBookSql_hb5(String ver) throws ParseException, IOException {
...
//                System.out.println("  ... debug ..."+s);
    ...
    public String getOneChapterContent(String ver, String bookChapter) throws ParseException, IOException {
        Path file = Paths.get("/home/mark/bible/content/hb5.txt");
        StringBuilder sb = new StringBuilder();
        ...
        try (BufferedReader reader = Files.newBufferedReader(file, charset)) {
            ...
            System.err.format("getOneChapterContent  ...IOException: %s%n", x);
        }
        return sb.toString();
    }
...
//        String ver = "tw";
//        String strHtml = getOneChapterContent("kjv", "B40C021");
        String strBook = String.format("B%02d", book);
        String strChapter = String.format("C%03d", chapter);
